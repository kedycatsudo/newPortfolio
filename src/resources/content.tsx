...
const home: Home = {
	...
	subline: (
		<>
			I’m Doruk, a Full-Stack Web Developer focused on creating efficient,
			scalable and secure web apps. Welcome to my portfolio!
		</>
	),
};
...
const about: About = {
	...
	intro: {
		...
		description: (
			<>
				I am Doruk Kocausta, a Full Stack Developer passionate about building
				practical, user-centered web applications that solve real problems. I
				focus on the intersection of product, design, and engineering turning
				ideas into reliable, maintainable systems.
			</>
		),
	},
	work: {
	...
	studies: {
		...
		institutions: [
			...
			},
			{
				name: "Tripleten",
				description: (
					<>Graduated from Tripleten Full Stack Developer Program.</>
				),
			},
		],
	},
